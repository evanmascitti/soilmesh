#' @title Masses and volumes of specimen molds for cleat-mark device
#'
#' @description Twelve aluminum cylinders were custom fabricated in February
...
#'   The process was similar to that outlined in [ASTM D 698-12e, Appendix
#'   A](https://www.astm.org/Standards/D698.htm). De-aired water was used to
...
#'   This process was performed _without_ the resin plug inside the cylinder, as
...
#'
#'   The resin volume was computed by measuring the plug's thickness to &plusmn; 0.01
