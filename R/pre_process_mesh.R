...
#'
#' @description Pipe together several other internal processing functions to
...
#'   `rot_tr_matrices` data object inside **soilmesh**`; the method development
#'   matrix already exists as an object ([`method_development_rtmatrix()`]).
...
#' @export
#'
pre_process_mesh <- function(mesh, rot_tr_matr, ...){
